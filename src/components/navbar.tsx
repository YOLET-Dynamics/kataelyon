...
export function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-36 py-4">
          ...
          >
            <Image
              ...
              width={600}
              height={180}
              className="h-36 w-auto drop-shadow-lg hover:scale-105 transition-transform duration-300"
              priority
            />
          </Link>
      ...
      >
        <div className="bg-background/95 backdrop-blur-md border-t border-border px-4 py-6 space-y-4">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
